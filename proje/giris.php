...
<div class="enustmenu" style = "filter: alpha (opacity = 50); opacity: 0.7;">
  ...
  <table cellspacing="2" cellpadding="2">
    ...
    <tr><td><input type="text" size="70" style="height:30px" name="eposta" placeholder="e-posta adresiniz"></td></tr>
	<tr><td>  <center>Şifre</td></tr>
    <tr><td><input type="password" size="70" style="height:30px" name="sifre" placeholder="şifreniz"></td></tr>
	<tr><td height="100"><center><input type="submit" value="GİRİŞ" style="height:30px;width:90px ;background-color:skyblue; border-radius:9px;"> </td></tr>
    

  </table>
  <?php include 'giriskodu.php';?>
  </form>
</div>
</body>
</html>